...
<div class="easyui-layout" fit="true">
			...
			<table class="centertable">
				<tr>
					...
					<td><input class="easyui-validatebox" type="password"
						name="pass" required="true" /></td>
				</tr>

				<tr>
					<td align="right">新密码：</td>
					<td><input class="easyui-validatebox" type="password"
						name="passa" required="true" /></td>
				</tr>

				<tr>
					<td align="right">确认新密码：</td>
					<td><input class="easyui-validatebox" type="password"
						name="passb" required="true" /></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<div region="south" class="buttomdiv">
		<a id="btn_pass" class="easyui-linkbutton" iconCls="icon-ok"
			href="javascript:void(0)">确认</a> &nbsp;&nbsp;&nbsp;&nbsp; <a
			class="easyui-linkbutton" iconCls="icon-cancel"
			href="javascript:void(0)" onclick="$('#win_pass').window('close');">关闭</a>
	</div>
</div>